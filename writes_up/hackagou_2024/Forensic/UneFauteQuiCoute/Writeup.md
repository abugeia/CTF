...
On remarque tout de suite que le multicast (Multicast DNS) à été utilisé par la victime issue d'une erreur de frappe "legend**ss**" au lieu de legendes.
...
## Résolution
Il y a donc eu une erreur de saisie, la demande et la fausse réponse de notre attaquant. La connexion SMB va donc s'initier. On filtre par smb || smb2 et on regarde ce qu'on a.
